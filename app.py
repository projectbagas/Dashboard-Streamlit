...
# =====================================================
# PEMBENTUKAN SENTIMEN (DARI RATING)
# =====================================================
...
df["sentimen_encoded"] = df["sentimen"].map(sentiment_map)
...
berdasarkan ulasan teks dan rating pengguna Google Play Store
...
X_tfidf = vectorizer.transform(df["review"].astype(str))
...
text_data = " ".join(
    df[df["sentimen"] == sentiment_option]["review"].astype(str)
)
